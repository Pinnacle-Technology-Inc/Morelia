...
class Setup_8480HR(Setup_Interface) : 
    """
    Setup_8480HR provides the setup functions for an 8206-HR POD device. \
    """
    # ============ GLOBAL CONSTANTS ============      ========================================================================================================================
    ...
    @staticmethod
    def _TtlSetup() -> int:
        """Asks the user to input values for Config format of  TTL Setup 
    ...
    @staticmethod
    def _ChoosePeriod():
        """Asks the user to input value for Stimulus Period 
    ...
    def _ChooseSyncConfig() -> int :
        """Asks the user to input value for Sync Config bits.
