...
class Pod8274D(Pod) : 
    ...
    def __init__(self, port: str|int, baudrate:int=921600) -> None :
        ...
        # NOTE TK -- 
        # for tuples longer than about 4 items, it is cleaner to use the tuple([U]*n)
        # format. Please change to that. Also, try to line up all the columns to be on 
        # the same tab position.
