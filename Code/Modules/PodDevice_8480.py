...
class POD_8480HR(POD_Basics) : 
    ...
    def __init__(self, port: str|int, deviceName: str, ssGain:dict[str,int|None]={'A':None,'B':None,'C':None,'D':None}, preampGain:dict[str,int|None]={'A':None,'B':None,'C':None,'D':None}, baudrate:int=9600) -> None :
        ...
        B5  = POD_8480HR.__B5BINARYLENGTH
        ...
        self._commands.AddCommand( 101, 'GET STIMULUS',         (U8,),                  (U8, U16*4, U32, U8),   False  ) # Requires U8 Channel.  Gets the current stimulus configuration for the selected channel.  See format below. 
        self._commands.AddCommand( 102,	'SET STIMULUS',	        (U8, U16*4, U32, U8),	(0,),                   False  ) # Sets the stimulus configuration on the selected channel.  See format below. 
        ...
        # self._channelMap : dict[str,str]|None = POD_8480HR.GetChannelMapping(deviceName)
