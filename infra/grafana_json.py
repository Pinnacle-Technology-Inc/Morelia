from Morelia.Devices import AquisitionDevice, PodDevice_8206HR, PodDevice_8401HR, PodDevice_8274D
import json
import re
...
# creates a grafana dashboard based on information passed in
def create_dashboard_from_device(filename: str, device: AquisitionDevice, device_port: str, data_source: str, input_title: str):
    data = {}
...
def create_dashboard_from_templates(device: AquisitionDevice | str, dashboard_name: str = "default_dashboard.json"):
