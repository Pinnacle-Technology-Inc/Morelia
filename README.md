...
| [PodDevice_8480SC.py](/Code/API_Modules/PodDevice_8480SC.py)          | POD_8480SC            | Handles communication using an 8480-SC POD device. | Pending | 
...
| [Setup_8480SC.py](/Code/API_Modules/Setup_8480SC.py)                  | Setup_8480SC          | Provides the setup functions for an 8480-SC POD device. | Pending |
...
| ^                                                                     | Params_8480           | Container class that stores parameters for a 8480-SC POD device. | Pending | 
