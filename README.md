...
| [Setup_8206HR.py](https://github.com/Pinnacle-Technology-Inc/Python-POD-API/blob/PA-16-Abstract-POD-device-setup/Code/Examples/Using_SetupPod_WithDescription.py) | Setup_8206HR | Provides the setup functions for an 8206-HR POD device. |
