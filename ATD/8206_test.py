...
target_vals = [ [[200, 200, 155], [0,0,0], [200,200,188]], [[200, 200, 155], [0,0,0], [200,200,188]], [[200, 200, 200], [0,0,0], [200,200,200]] ]
...
if __name__ == "__main__":
    ...
    test1_name = '-20hz-30lpf'
    test2_name = '-40hz-30lpf'
    test3_name = '-40hz-50lpf'
    ...
    # for x in dut_list:
    #     zip_dirs.append(str(x[0]) + output_dir)
    #     if zip_name != '':
    #         zip_name = zip_name + '-'
    #     zip_name = zip_name + str(x[0])

    # zip_name = zip_name + '.zip'
    # zip_list.append(zip_name)
    # zip_list.append(log_file)

    # for x in zip_dirs:
    #     zip_list.append(x)

    # subprocess.run(zip_list)
    # subprocess.run(['mv', zip_name, output_path])

    # # clean up
    # print ("Cleaning up")
    # for x in zip_dirs:
    #     subprocess.run(['rm', '-r', x])
